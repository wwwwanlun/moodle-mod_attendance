...
$string['attendance:modifications'] = 'Add/Edit Modifications';
$string['attendance:morereports'] = 'View SALT reports';
$string['attendance:changeattendancesafterdeadline'] = 'Edit Attendance For SALT';
...
$string['confirminactive'] = 'Are you sure you want to inactive the modification for user \'{$a->userid}\' ?<br/>This action is irreversible.';
